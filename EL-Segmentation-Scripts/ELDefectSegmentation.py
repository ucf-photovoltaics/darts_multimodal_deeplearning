...
##################################################
img_path = '/mnt/vstor/CSE_MSE_RXF131/cradle-members/sdle/jmr375/UCF-EL-Defect/M55 EL Data/1x1/Cells/Cell_Images0'             # folder where images are
model_path = 'models'                # folder where model is stored
model_name = 'model_97.pth'           # trained model name
save_path = '/mnt/vstor/CSE_MSE_RXF131/cradle-members/sdle/jmr375/UCF-EL-Defect/M55 EL Data/1x1/Visuals'                # location to save figures
defect_dir = '/mnt/vstor/CSE_MSE_RXF131/cradle-members/sdle/jmr375/UCF-EL-Defect/M55 EL Data/1x1/Defects'    # location to save defect percentage jsons
...
with torch.no_grad():
    ...
    while i < len(filelist):
        ...
        if im.size[0] > 2000:
            ...
            try:
                cell_cropping.CellCropComplete(os.path.join(img_path, filelist[i]), i=i, NumCells_y=6, NumCells_x=10, corners_get='auto')
            except cv2.error:
